        ...
        nameLabel.setOnMouseReleased(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent t) {
                ...
                if(!t.isStillSincePress()) {
                    ...
                    Scene tabScene = new Scene(pane);
                    tabScene.getStylesheets().add(getClass().getClassLoader().getResource("com/scibag/css/blue_theme.css").toString());
                    
                    newStage.setScene(tabScene);
